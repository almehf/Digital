...
class UserProfileHeader: UICollectionViewCell {
    ...
    fileprivate func setupBottomToolBar() {
        ...
        stackView.distribution = .fillEqually
        stackView.anchor(top: usernameLabel.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 50)
